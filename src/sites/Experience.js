    ...
    <div name="experience" id="techstack" className='bg-gradient-to-b from-black to-gray-500 w-full h-auto p-4'>
      <div className='max-w-screen-lg mx-auto flex flex-col justify-center w-full h-auto text-white mt-[80px]'>
            ...
            <div className='w-full grid grid-cols-3 sm:grid-cols-4 gap-8 text-center py-8 px-4 md:px-12 sm:px-0'>
                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-red-500'>
                    <FaHtml5 size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>HTML</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-blue-500 '>
                    <FaCss3Alt size={80} className='w-20 mx-auto ' />
                    <p className='mt-4'>Css</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-yellow-400'>
                    <IoLogoJavascript size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>JS</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-purple-400'>
                    <FaPhp size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>PHP</p>
                </div>
           
                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-red-400'>
                    <SiCraftcms size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>Craft CMS</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-orange-400'>
                    <FaTypo3 size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>Typo3</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-blue-400'>
                    <FaNeos size={80} className='w-20 mx-auto' />
                    <p className='mt-4'>Neos CMS</p>
                </div>

                <div className='md:hover:scale-105 duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-purple-600'>
            ...
            <div className='w-full grid grid-cols-3 sm:grid-cols-4 gap-8 text-center py-8 px-4 md:px-12 sm:px-0'>
                <div className='md:hover:scale-105  duration-500 rounded-lg py-2 md:hover:shadow-lg md:hover:shadow-sky-500'>
