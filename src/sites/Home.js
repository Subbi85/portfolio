  ...
  return (
    ...
    <div className='h-full max-w-screen-lg mx-auto flex flex-col-reverse items-center justify-centerh-full px-4 md:flex-row text-white'>
        <div className='flex flex-col justify-center h-full'>
          ...
          <div>
            <a href="/#portfolio">
              <button className='relative group text-white w-fit px-6 py-3 flex items-center rounded-md bg-gradient-to-r from-blue-500 to-blue-800 cursor-pointer z-50'> 
                Portfolio
